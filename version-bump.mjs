...
writeFileSync(`${appFolder}/${manifestFile}`, JSON.stringify(manifest, null, "\t"));
// Replace write by a copy
writeFileSync(`${targetFolder}/${manifestFile}`, JSON.stringify(manifest, null, "\t"));
...
writeFileSync(`${appFolder}/${versionsFile}`, JSON.stringify(versions, null, "\t"));
// Replace write by a copy
writeFileSync(`${targetFolder}/${versionsFile}`, JSON.stringify(versions, null, "\t"));
